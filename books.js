// When we set filter as a parameter on renderBooks we are giving anoter name to event.target.value
// that estabilished on filter books
let books;
...
async function renderBooks(filter) {
  ...
  booksWrapper.innerHTML = booksHtml; // this adds the actual content into the Html
}
